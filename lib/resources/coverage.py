...
def generate_coverage(patient_id: str, organization_id: str, 
    ...
    cost_sharing = random.choice(COVERAGE_COST_SHARING)
        ...
        coverage["costToBeneficiary"] = [
            {
                ...
                "valueMoney": {
                    ...
                    "currency": "USD"
                } if cost_sharing["type"] in ["copay", "deductible"] else {
                    "value": cost_sharing.get("percentage", 20),
                    "currency": "USD"
                }
            }
        ]
    ...
    # Add benefit information (50% chance)
    ...
    coverage["text"] = {
        ...
        "div": f"""<div xmlns="http://www.w3.org/1999/xhtml">
            ...
            <p><b>Benefits:</b> {', '.join(benefit_types)}</p>
